...
### KY2 체인의 확장성
저희가 직접 개발한 KYE 블록 체인은 단순히 장병 자격 인증 시스템에 머물지 않습니다.  
[KYE npm document](https://www.npmjs.com/package/ky2)
어느 프로젝트에서든 저희 블록체인에 요청을 날려 **신뢰성 있는 분산 데이터 저장 시스템** 을 이용할 수 있습니다.  

이번 해커톤에서는 자격 인증 평가에 초점을 두었지만 이는 **KYE 체인의 여러 사용 케이스 중 하나일 뿐** 어디서든, 누구나 자신의 서비스에 활용 가능합니다.
